    ...
    <div className="min-h-screen-safe bg-slate-900 flex">
      ...
      <aside className="hidden md:flex w-64 bg-slate-800/50 border-r border-slate-700/50 flex-col shrink-0 overflow-y-auto">
        ...
        <nav className="flex-1 p-4 space-y-1">
          <NavItem href="/home" icon="grid">All Apps</NavItem>
          ...
          <NavItem href="/meetingflow" icon="video">MeetingFlow</NavItem>
          <NavItem href="/scheduleflow" icon="schedule">ScheduleFlow</NavItem>
          <NavItem href="/documents" icon="document">Documents</NavItem>
