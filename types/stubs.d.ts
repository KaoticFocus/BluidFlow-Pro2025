...
// ============================================================================
// Prisma Client stub - Only used if @prisma/client is not available
// ============================================================================

// Note: This stub is only used as a fallback. The actual Prisma Client
// types are generated by `prisma generate` and should take precedence.
// If you see type errors, run: cd packages/db && npx prisma generate
...
declare module "@buildflow/shared" {
  // Re-export all from shared package index
  // Using relative path from types/ directory
